> ## ⚠️ 本仓库已归档，停止发版
>
> CleanFnOS 的开发与发布已迁移至统一应用仓库：
>
> - **下载最新版**：https://kyeo.top/apps （应用展示与直链下载）
> - **源码仓库**：https://cnb.cool/kyeo.top/kyeo-apps （应用源码 + CI 自动构建双架构 fpk）
> - **应用内更新**：已装用户无需操作，应用启动时会自动检查新版本并提示
>
> 本仓库保留历史版本下载与 Issue 存档，不再接受新版本发布。欢迎到新仓库提 Issue ⭐️
>
> —— 2026-09 归档
> 
...
| **文件去重** | SHA-256 流式哈希（先按大小分组只哈希同大小文件），识别内容完全相同的重复文件 |
...
| v1.3.0 | 文件去重 + 大文件 + 系统清理 17 项 + 定时清理 |
